...
<?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            $query = "SELECT * FROM tbl_user WHERE user_name = '$username' AND 
            ...
            if ($result != false) {
                ...
                if ($row > 0) {
                    ...
                    echo "<span class='err'>No result found !</span>";
                }
            }else{
                echo "<span class='err'>Username or Password not matched !</span>";
            }
        }
?>
